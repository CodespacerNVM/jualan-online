        ...
        <div class="flex flex-1 items-center justify-end gap-8">
            ...
            <div class="flex items-center">
                <div class="flex items-center divide-x divide-gray-100 border-x border-gray-100">
                    <span>
                        <a href="/cart" class="block border-b-4 border-transparent p-6 hover:border-red-700 transition duration-300">
                    ...
                    <span>
                        <a href="{{ Auth::check() ? route('profile.show') : route('login') }}" class="block border-b-4 border-transparent p-6 hover:border-red-700 transition duration-300">
                    ...
                    <span class="hidden sm:block">
                        <a href="/search" class="block border-b-4 border-transparent p-6 hover:border-red-700 transition duration-300">
                            <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
